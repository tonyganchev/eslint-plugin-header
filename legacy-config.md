...
This plugin continues to support the configuration format of
[eslint-plugin-header](https://github.com/Stuk/eslint-plugin-header) which we
...
The _header_ rule takes between 1 and 4 arguments after the rule validation
severity.
